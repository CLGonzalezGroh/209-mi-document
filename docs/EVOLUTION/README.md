...
| `BLOCK_02C_ALCANCE_POR_PROYECTO.md` | Alcance por proyecto de clase y tipo, aplicando el mecanismo que construyó `BLOCK_02B`: clase y tipo declaran juntos, siembra conjunta con identidad por código dentro de la clase, y corrección de la deriva de claves foráneas. Primer bloque sobre objetos con datos e interfaz en producción | `APROBADO_PENDIENTE` |
