...
| `BLOCK_03_CICLO_INTERNO.md` | Tercer bloque: el circuito completo desde el armado hasta la toma de conocimiento, revisión externa y versión interna, circuitos sucesivos, firma verificable, delegación y reasignación, esquema de revisión propuesto y no persistido, y abandono de la revisión | `LISTO_PARA_PROMOVER` |
